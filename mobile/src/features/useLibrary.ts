...
/**
 * Поиск по своей медиатеке — мгновенный, без сети. Пустой запрос возвращает
 * весь список: на экране медиатеки поиск это фильтр поверх всего,
 * а не отдельный режим.
 *
 * Идёт по уже загруженному кэшу, то есть находит только то, что успело
 * подгрузиться пагинацией.
 *
